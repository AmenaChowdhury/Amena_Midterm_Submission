...
public class EmployeeInfo extends AllDept implements Employee {
	 ...
	 */
	final static String companyName = "Money Exchange";
	int employeeId;
	String name;
	...
	public void allDept() {
		System.out.println("The Deprtments are: \n" + dept1 + "\n" + dept2 + "\n" +
				dept3);
	}
	...
	public void setEmpDepartments(String s){
		dep = s;
	}
